...
const ALCHEMY_API_KEY = import.meta.env.VITE_API_KEY
  ...
  if (window.ethereum) {
    ...
    return {
      ...
      status: (
        <span>
          {" "}
          Please install <a href="https://metamask.io/download">Metamask</a>, a
          virtual ethereum wallet, in your browser.
        </span>
      ),
    }
  }
